...
@section('content')
   ...
   <form action="{{ route('store') }}" method="POST" class="grid gap-5 w-full content-input">
      <div class="flex flex-col shadow-md rounded-lg p-5">
         ...
         <input class="border border-dark px-2 py-1 focus:outline-none input-mask" value="{{ $numero->numero_double1 }}" data-input-value='.numero-1' data-thousands-separator='.' data-decimal-separator=',' type="text">
         <div class="my-2">
      ...
      <div class="flex flex-col shadow-md rounded-lg p-5">
         <label class="mb-2" for="">Input / miles ',' y decimal '.'</label>
         <input class="border border-dark px-2 py-1 focus:outline-none input-mask" value="{{ $numero->numero_double1 }}"  data-input-value='.numero-2' data-thousands-separator=',' data-decimal-separator='.' type="text">
         <div class="my-2">
            <label for="" class="block text-gray-400 italic">Salida</label>
